...
let {listar,mostrarTareas,listarTareas,filtrarPorEstado,cambiarEstado,agregarTarea,borrarPrimerTarea,borrarUltimaTarea,borrarTarea} = require("./funcionesDeTareas");
